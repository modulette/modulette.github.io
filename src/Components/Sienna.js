...
class Sienna extends Component {
  render() {
    return (
                ...
                <div className="container">
                    <div className="hero-inner">
						<div className="hero-copy">
	                        ...
	                        <p className="hero-cta"><a className="button button-primary button-shadow" href="#">Pricing and plans</a></p>
						</div>
						<div className="hero-illustration">
							...
							<div className="hero-media is-revealing" style={{perspective:"800px"}}>
								<svg width="528" height="401" viewBox="0 0 528 401" xmlns="http://www.w3.org/2000/svg">
									...
									<path fill="#FFF" d="M0 52L528 .832v399.336L0 349z" style={{"mixBlendMode":"multiply","filter":"url(#dropshadow-media)"}}/>
                ...
                <div className="container">
                    <div className="features-extended-inner section-inner has-top-divider">
                        <div className="features-extended-header text-center">
                            <div className="container-sm">
                                <h2 className="section-title mt-0">Meet Sienna</h2>
                        ...
                        <div className="feature-extended">
                            <div className="feature-extended-image is-revealing">
                                <svg width="480" height="320" viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                    <defs>
                                        ...
                                        <filter id="dropshadow-1" x="-500%" y="-500%" width="1000%" height="1000%">
                                            <feDropShadow dx="0" dy="16" stdDeviation="24" floodColor="#E7EBF6" floodOpacity="1" />
                                        </filter>
                                    ...
                                    <g transform="translate(57 40)">
										<use fill="#FFF" xlinkHref="#features-1-a" style={{"mixBlendMode":"multiply","filter":"url(#dropshadow-media)"}}/>
                                    ...
                                    <circle fill="#FFF" cx="293" cy="256" r="40" style={{"mixBlendMode":"multiply","filter":"url(#dropshadow-media)"}}/>
                                ...
                                <svg width="480" height="320" viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                    ...
                                    <g fill="none" fillRule="evenodd">
                                        ...
                                        <g transform="translate(70 23)">
                                            <use fill="#FFF" xlinkHref="#feature-2-a" style={{"mixBlendMode":"multiply","filter":"url(#dropshadow-f-2)"}}/>
                                            ...
                                            <g transform="rotate(45 209.569 65.569)">
                                                ...
                                                <use fill="#FFF" xlinkHref="#feature-2-f" style={{"mixBlendMode":"multiply","filter":"url(#dropshadow-f-2)"}}/>
                                ...
                                <svg width="480" height="320" viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                    ...
                                    <g fill="none" fillRule="evenodd">
                                        ...
                                        <g transform="translate(80 40)">
                                            <use fill="#FFF" xlinkHref="#features-3-a" style={{"mixBlendMode":"multiply","filter":"url(#dropshadow-f-2)"}}/>
                                        ...
                                        <path fill="#FFF" d="M216 24h80v80h-80z" style={{"mixBlendMode":"multiply","filter":"url(#dropshadow-f-2)"}}/>
						...
						<div className="testimonials-wrap">
								...
								<div className="testimonial-inner">
									<div className="testimonial-main">
										<div className="testimonial-header">
											<img className="mb-16" src="public/images/testimonial-01.png" alt="Testimonial" />
										</div>
									...
									<div className="testimonial-footer">
										<div className="testimonial-name">Mark Simons</div>
							...
							<div className="testimonial text-center text-xs is-revealing">
								<div className="testimonial-inner">
									<div className="testimonial-main">
										<div className="testimonial-header">
											<img className="mb-16" src="public/images/testimonial-02.png" alt="Testimonial" />
										</div>
										<div className="testimonial-body">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p>
										</div>
									...
									<div className="testimonial-footer">
										<div className="testimonial-name">Emma Patrick</div>
										<div className="testimonial-link">
											<a href="#">fast.com</a>
										</div>
									</div>
							...
							<div className="testimonial text-center text-xs is-revealing">
								<div className="testimonial-inner">
									<div className="testimonial-main">
										<div className="testimonial-header">
											<img className="mb-16" src="public/images/testimonial-03.png" alt="Testimonial" />
										</div>
										<div className="testimonial-body">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p>
										</div>
									...
									<div className="testimonial-footer">
										<div className="testimonial-name">David Harris</div>
										<div className="testimonial-link">
                        ...
                        <div className="pricing-tables-wrap">
                                ...
                                <div className="pricing-table-inner">
                                    <div className="pricing-table-main">
                                        <div className="pricing-table-header">
                                            <div className="pricing-table-title mt-12 mb-16">Monthly</div>
                                            <div className="pricing-table-price pb-32"><span className="pricing-table-price-currency h3">$</span><span className="pricing-table-price-amount h1">29</span>/m</div>
                                        </div>
                            ...
                            <div className="pricing-table pricing-table-primary text-light is-revealing">
                                <div className="pricing-table-inner">
                                    <div className="pricing-table-main">
                                        <div className="pricing-table-header">
                                            <div className="pricing-table-title mt-12 mb-16">Yearly</div>
                                            <div className="pricing-table-price pb-32"><span className="pricing-table-price-currency h3">$</span><span className="pricing-table-price-amount h1">19</span>/m</div>
                                        </div>
                                        <ul className="pricing-table-features list-reset text-xs">
                                            <li>
                                                <span>Lorem ipsum dolor sit consectetur</span>
                                    ...
                                    <div className="pricing-table-cta">
                                        <a className="button button-shadow button-block" href="#">Get started</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer className="site-footer">
            <div className="container">
                <div className="site-footer-inner">
                    ...
                    <div className="footer-copyright">&copy; 2018 Sienna, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
